...
- 3.3 Temporal difference와의 비교
- 3.2와 3.3은 모두 full-width backup이 아닌 sample backup 방식
  ...
  - *Model-free*
- 3.2는 bootstrapping하지 않지만 3.3은 bootstrapping 사용
...
- 또한 1-step부터 n-step까지의 return을 합치기도 함  
  - Forward-view : weighted average방식. step이 길어질 수록 ratio $$\lambda$$로 decaying시킨다. 
