---
title: Statistical Learning Theory (1) - VC Bound
use_math: true
classes: wide
layout: single
---   
...
- $$\cal{F_{z_1, ..., z_n}} = \left\{ f \in \cal{F}: (f(z_1), ... f(z_n)) \mid  z_1,...z_n  \right\}$$
  - 이를 function space->data space의 projection이라고 부른다.
